...
describe(`${CategoriesService.name}`, () => {
  ...
  it(`${CategoriesService.prototype.findById.name}() should return null when category is not found`, async () => {
    jest.spyOn(prismaService.categories, 'findFirst').mockReturnValueOnce(null);
    const response = await service.findById('123456');
  ...
  it(`${CategoriesService.prototype.update.name}() should return null when category is not found`, async () => {
    jest.spyOn(prismaService.categories, 'update').mockReturnValueOnce(null);
    const response = await service.update({
      id: `123`,
  ...
  it(`${CategoriesService.prototype.delete.name}() should delete category`, async () => {
    jest.spyOn(prismaService.categories, 'delete').mockReturnValueOnce(null);
